...
# Add 1 day to get the data for the day before eg. (year=2024,month=1,day=2,hour=00,minute=00,second=00) to get 2024-01-01
timestamp_from = convert_datetime_to_timestamp(year=2024,month=1,day=2,hour=00,minute=00,second=00)

# Put the same date eg. (year=2024,month=2,day=4,hour=23,minute=59,second=59) to get 2024-02-04
timestamp_to = convert_datetime_to_timestamp(year=2024,month=2,day=4,hour=23,minute=59,second=59)
...
for i in range(len(accountId)):
    ...
    if response.status_code == 200: 
        ...
        AIRTABLE_TABLE_NAME = 'statisticsDateNew'
